        ...
        <div className=" ">
            ...
            <div className="max-h-[calc(100vh-190px)] overflow-y-auto p-5 pb-10">
                ...
                <div className="flex items-center justify-between gap-2 mt-3">
                    <div className="flex items-center flex-col justify-center gap-2 cursor-pointer bg-[#ffffff] rounded-[14px] p-4 w-full shadow-[0_1px_2px_rgba(0, 0, 0, 0.05)]" onClick={() => router.push("/user/send-money")}>
                        <SendIcon />
                        <p className="text-greyDark text-[12px] font-semibold ">Send</p>
                    </div>
                    <div className="flex items-center flex-col justify-center gap-2 cursor-pointer bg-[#ffffff] rounded-[14px] p-4 w-full shadow-[0_1px_2px_rgba(0, 0, 0, 0.05)]" onClick={() => router.push("/user/withdraw-money")}>
                        <WithdrawIcon />
                        <p className="text-greyDark text-[12px] font-semibold">Withdraw</p>
                    </div>
                    <div className="flex items-center flex-col justify-center gap-2 cursor-pointer bg-[#ffffff] rounded-[14px] p-4 w-full shadow-[0_1px_2px_rgba(0, 0, 0, 0.05)]" onClick={() => router.push("/user/pay-scan")}>
                        <PayScanIcon />
                ...
                <div className="flex items-center justify-between gap-2 mt-3">
                    <button onClick={() => router.push("/user/add-money")} className="flex items-center justify-between gap-2 cursor-pointer bg-[#ffffff] rounded-[14px] p-4 w-full shadow-[0_1px_2px_rgba(0, 0, 0, 0.05)]">
